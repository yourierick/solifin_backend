...
class JobOfferValidationController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    // public function validate(Request $request, $offer)
    // {
    //     // Vérifier si l'utilisateur est un administrateur
    //     if (!Auth::user()->is_admin) {
    //         return response()->json(['message' => 'Non autorisé'], 403);
    ...
    //     $offreEmploi = OffreEmploi::findOrFail($offer);
        
    //     if ($request->action === 'approve') {
    //         // Approuver l'offre d'emploi
    //         $offreEmploi->statut = 'approuve';
    //         $offreEmploi->save();
            
    //         // Notifier l'utilisateur
    //         $user = User::find($offreEmploi->user_id);
    //         $user->notify(new PublicationStatusChanged([
    //             'type' => 'offres_emploi',
    //             'id' => $offreEmploi->id,
    //             'titre' => $offreEmploi->titre,
    ...
    //         ]);
    //     } else {
    //         // Rejeter l'offre d'emploi
    //         $offreEmploi->statut = 'rejete';
    //         $offreEmploi->raison_rejet = $request->reason;
    //         $offreEmploi->save();
    ...
    /**
     * Récupérer les offres d'emploi approuvées
     *
     * @return \Illuminate\Http\Response
     */
    ...
    //     try {
    //         $approvedJobs = OffreEmploi::with('user')
    ...
    //     } catch (\Exception $e) {
    //         return response()->json(['message' => 'Erreur lors de la récupération des offres d\'emploi approuvées', 'error' => $e->getMessage()], 500);
    //     }
    // }
    
    /**
     * Récupérer les offres d'emploi rejetées
     *
     * @return \Illuminate\Http\Response
     */
    ...
    //     try {
    //         $rejectedJobs = OffreEmploi::with('user')
    //             ->where('statut', 'rejete')
    //             ->orderBy('created_at', 'desc')
    //             ->get()
    //             ->map(function ($job) {
    ...
    //         return response()->json($rejectedJobs);
    //     } catch (\Exception $e) {
    //         return response()->json(['message' => 'Erreur lors de la récupération des offres d\'emploi rejetées', 'error' => $e->getMessage()], 500);
    //     }
    // }
